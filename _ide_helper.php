...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \CTP\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CTP\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function command($signature, $callback){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CTP\Console\Kernel::command($signature, $callback);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CTP\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CTP\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CTP\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \CTP\Console\Kernel::output();
        }
        ...
        public static function setArtisan($artisan){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \CTP\Console\Kernel::setArtisan($artisan);
        }
    ...
    class VatsimSSO extends \Vatsim\OAuth\Facades\SSO{
         ...
         * @static 
         */
        public static function format($change = false){
            return \Vatsim\OAuth\SSO::format($change);
        }
         ...
         * @static 
         */
        public static function signature($signature, $private_key = false){
            return \Vatsim\OAuth\SSO::signature($signature, $private_key);
        }
         ...
         * @static 
         */
        public static function requestToken($return_url = false, $allow_sus = false, $allow_ina = false){
            return \Vatsim\OAuth\SSO::requestToken($return_url, $allow_sus, $allow_ina);
        }
         ...
         * @static 
         */
        public static function sendToVatsim(){
            return \Vatsim\OAuth\SSO::sendToVatsim();
        }
         ...
         * @param \Vatsim\OAuth\secret $tokenSecret The secret associated with the token
        ...
        public static function checkLogin($tokenKey, $tokenSecret, $tokenVerifier){
            return \Vatsim\OAuth\SSO::checkLogin($tokenKey, $tokenSecret, $tokenVerifier);
        }
        ...
        public static function login($returnUrl, $success, $error = null){
            return \Vatsim\OAuth\SSO::login($returnUrl, $success, $error);
        }
        ...
        public static function validate($key, $secret, $verifier, $success, $error = null){
            return \Vatsim\OAuth\SSO::validate($key, $secret, $verifier, $success, $error);
        }
